...
[![arXiv](https://img.shields.io/badge/arXiv-2607.02686-b31b1b)](https://arxiv.org/abs/2607.02686)
...
If you use this code, please cite the workshop paper, the companion planning paper, and the original ASK paper:

```bibtex
@inproceedings{monteiro2026askpomdp,
  title     = {ASK in the Dark: Uncertainty-Gated {LLM} Assistance under Partial Observability},
  author    = {Juarez Monteiro and Nathan Gavenski and Guilherme Lima and Odinaldo Rodrigues and Adriano Veloso},
...
@inproceedings{gavenski2026plan,
  title     = {When in Doubt, Plan It Out: Committed Small Language Model Deliberation for Reactive Reinforcement Learning},
  author    = {Nathan Gavenski and Juarez Monteiro and Francisco Galuppo and Adriano Veloso and Odinaldo Rodrigues},
