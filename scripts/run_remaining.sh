...
#
# Order:
#   1. SLM-only  — Qwen3-0.8B, Qwen3-2B
#   2. ASK       — Qwen2.5-0.5B,  Qwen2.5-1.5B
#   3. ASK       — Qwen3-0.8B,  Qwen3-2B
#
...
# --- 3. ASK: Qwen3 ---
echo ""
echo "[3/3] ASK — Qwen3-0.8B (Optuna + eval)"
python eval_ppo_slm.py --mode ask --slm qwen3-0.6b --wandb-group main

echo ""
echo "[3/3] ASK — Qwen3-2B (Optuna + eval)"
